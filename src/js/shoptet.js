...
(function (a, b) {
    ...
    p.extend({
        ...
        acceptData: function (a) {
            ...
            return !b || (b !== !0 && a.getAttribute && a.getAttribute('classid') === b);
        },
    }),
        p.fn.extend({
            data: function (a, c) {
        ...
        (function (a, b) {
            ...
            var c,
                ...
                ba = X(function (a) {
                    ...
                    var b =
                        r.getElementsByName && r.getElementsByName(o).length === 2 + r.getElementsByName(o + 0).length;
                ...
                (p.sub = function () {
                    ...
                    p.extend(!0, a, this),
                        ...
                        (a.fn.init = function c(c, d) {
                            return (
                                d && d instanceof p && !(d instanceof a) && (d = a(d)), p.fn.init.call(this, c, d, b)
                            );
                        }),
    ...
    p.fn.extend({
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                .filter(function () {
                    return (
                        this.name && !this.disabled && (this.checked || ch.test(this.nodeName) || cg.test(this.type))
                    );
                })
                .map(function (a, b) {
                    var c = p(this).val();
            ...
            run: function (a) {
                ...
                return (
                    this.options.duration
                        ? (this.pos = b =
                              p.easing[this.easing](a, this.options.duration * a, 0, 1, this.options.duration))
                        : (this.pos = b = a),
                ...
                drag: function (t, n) {
                    ...
                    for (var l = r.snapElements.length - 1; l >= 0; l--) {
                        ...
                        if (i.snapMode != 'inner') {
                            ...
                            v &&
                                (n.position.top =
                                    r._convertPositionTo('relative', { top: p - r.helperProportions.height, left: 0 })
                                        .top - r.margins.top),
                                m &&
                                    (n.position.top =
                                        r._convertPositionTo('relative', { top: d, left: 0 }).top - r.margins.top),
                                g &&
                                    (n.position.left =
                                ...
                                y &&
                                    (n.position.left =
                                        r._convertPositionTo('relative', { top: 0, left: h }).left - r.margins.left);
                        }
                        var b = v || m || g || y;
                        if (i.snapMode != 'outer') {
                            ...
                            v &&
                                (n.position.top =
                                    r._convertPositionTo('relative', { top: p, left: 0 }).top - r.margins.top),
                                m &&
                                    (n.position.top =
                                        r._convertPositionTo('relative', {
                                ...
                                g &&
                                    (n.position.left =
                                        r._convertPositionTo('relative', { top: 0, left: c }).left - r.margins.left),
                                y &&
                                    (n.position.left =
                                        r._convertPositionTo('relative', {
                                            top: 0,
                ...
                resize: function (t, n) {
                    ...
                    c[0] != document && /static/.test(c.css('position')) && (l = o),
                        a.left < (r._helper ? o.left : 0) &&
                            ((r.size.width =
                                r.size.width + (r._helper ? r.position.left - o.left : r.position.left - l.left)),
                                ...
                                : (a.selecting &&
                                      ((t.metaKey || t.ctrlKey) && a.startselected
                                          ...
                                          : (a.$element.removeClass('ui-selecting'),
                                            (a.selecting = !1),
                                            a.startselected &&
                                                (a.$element.addClass('ui-unselecting'), (a.unselecting = !0)),
        ...
        e.widget('ui.sortable', e.ui.mouse, {
            ...
            _mouseStart: function (t, n, r) {
                ...
                (this.currentContainer = this),
                    ...
                    i.cursor &&
                        (e('body').css('cursor') && (this._storedCursor = e('body').css('cursor')),
            ...
            _intersectsWithPointer: function (t) {
                var n =
                        this.options.axis === 'x' ||
                        e.ui.isOverAxis(this.positionAbs.top + this.offset.click.top, t.top, t.height),
                    r =
                        this.options.axis === 'y' ||
                        e.ui.isOverAxis(this.positionAbs.left + this.offset.click.left, t.left, t.width),
                    i = n && r,
                ...
                for (var s = r.length - 1; s >= 0; s--) {
                    ...
                    for (var u = 0, c = l.length; u < c; u++) {
                        ...
                        h.data(this.widgetName + '-item', f),
                            n.push({ item: h, instance: f, width: 0, height: 0, left: 0, top: 0 });
                    }
                }
            },
                ...
                if (this.containers.length === 1)
                    ...
                    for (var l = this.items.length - 1; l >= 0; l--) {
                        ...
                        Math.abs(c - f) > Math.abs(c + this.items[l][a] - f) && ((h = !0), (c += this.items[l][a])),
                            Math.abs(c - f) < s &&
                                ((s = Math.abs(c - f)), (o = this.items[l]), (this.direction = h ? 'up' : 'down'));
                    }
                        ...
                        (e.effects.animateClass = function (t, r, o, u) {
                            ...
                            return this.queue(function () {
                                ...
                                (f = f.map(function () {
                                    ...
                                    (f = f.map(function () {
                                        return (
                                            (this.end = i.call(this.el[0])), (this.diff = s(this.start, this.end)), this
                                        );
                                    })),
                                    r.attr('class', o),
                                    (f = f.map(function () {
                ...
                (function (e, t) {
                    ...
                    t._findActive = function (e) {
                        return (
                            ...
                            e &&
                                typeof e != 'number' &&
                                ((e = this.headers.index(this.headers.filter(e))), e === -1 && (e = !1)),
                            n.call(this, e)
                        );
                    };
                })(jQuery, jQuery.ui.accordion.prototype),
        ...
        $.extend(Datepicker.prototype, {
            ...
            parseDate: function (e, t, n) {
                ...
                a == -1
                    ...
                    : a < 100 &&
                      (a += new Date().getFullYear() - (new Date().getFullYear() % 100) + (a <= r ? 0 : -100));
                if (c > -1) {
                    (f = 1), (l = c);
                    do {
            ...
            _generateHTML: function (e) {
                ...
                m = s
                    ? this.formatDate(m, this._daylightSavingAdjust(new Date(d, p - a, 1)), this._getFormatConfig(e))
                    : m;
                ...
                y = s
                    ? this.formatDate(y, this._daylightSavingAdjust(new Date(d, p + a, 1)), this._getFormatConfig(e))
                    : y;
                ...
                for (var j = 0; j < o[0]; j++) {
                    ...
                    for (var I = 0; I < o[1]; I++) {
                        ...
                        for (var Y = 0; Y < Q; Y++) {
                            U += '<tr>';
                            var Z = N
                                ? '<td class="ui-datepicker-week-col">' + this._get(e, 'calculateWeek')(G) + '</td>'
                                : '';
                            for (var W = 0; W < 7; W++) {
                        ...
                        p++,
                            ...
                            (U +=
                                ...
                                (f
                                    ? '</div>' +
                                      (o[0] > 0 && I == o[1] - 1 ? '<div class="ui-datepicker-row-break"></div>' : '')
                                    : '')),
                            (F += U);
                    }
                    B += F;
                ...
                resize: function () {
                    ...
                    e.each(e.ui.dialog.overlay.instances, function () {
                        ...
                        t
                            ...
                            .css({ width: e.ui.dialog.overlay.width(), height: e.ui.dialog.overlay.height() });
                },
            }),
                        ...
                        (this.range = e('<div></div>')
                            ...
                            .addClass(
                                'ui-slider-range ui-widget-header' +
                                    (i.range === 'min' || i.range === 'max' ? ' ui-slider-range-' + i.range : ''),
                            ))),
    ...
    (function (e) {
        ...
        e.widget('ui.spinner', {
            ...
            _value: function (e, t) {
                var n;
                e !== '' &&
                    ((n = this._parse(e)), n !== null && (t || (n = this._adjustValue(n)), (e = this._format(n)))),
                    this.element.val(e),
                    this._refresh();
            },
            _destroy: function () {
                ...
                (function () {
                    ...
                    e.widget('ui.tabs', e.ui.tabs, {
                        ...
                        _create: function () {
                            ...
                            e.active == null &&
                                e.cookie &&
                                ((t = parseInt(this._cookie(), 10)), t === -1 && (t = !1), (e.active = t)),
                                this._super();
                        },
                        _cookie: function (n) {
                            var r = [this.cookie || (this.cookie = this.options.cookie.name || 'ui-tabs-' + ++t)];
                            return (
                                arguments.length && (r.push(n === !1 ? -1 : n), r.push(this.options.cookie)),
                    ...
                    t &&
                        ...
                        r.parents().each(function () {
                            ...
                            e(this).data('tooltip-open') &&
                                ((t = e.Event('blur')), (t.target = t.currentTarget = this), n.close(t, !0)),
                                this.title &&
                                    (e(this).uniqueId(),
                ...
                e.each(this.tooltips, function (n, r) {
                    ...
                    (i.target = i.currentTarget = r[0]),
                        ...
                        r.data('ui-tooltip-title') &&
                            (r.attr('title', r.data('ui-tooltip-title')), r.removeData('ui-tooltip-title'));
                });
            },
        });
    })(jQuery);
/* Shoptet backend_master_web as was generated at 2020/02/13 */
jQuery(function ($) {
    $.datepicker.regional['cs'] = {
        ...
        monthNamesShort: ['led', 'Ăşno', 'bĹ™e', 'dub', 'kvÄ›', 'ÄŤer', 'ÄŤvc', 'srp', 'zĂˇĹ™', 'Ĺ™Ă­j', 'lis', 'pro'],
        dayNames: ['nedÄ›le', 'pondÄ›lĂ­', 'ĂşterĂ˝', 'stĹ™eda', 'ÄŤtvrtek', 'pĂˇtek', 'sobota'],
        dayNamesShort: ['ne', 'po', 'Ăşt', 'st', 'ÄŤt', 'pĂˇ', 'so'],
        dayNamesMin: ['ne', 'po', 'Ăşt', 'st', 'ÄŤt', 'pĂˇ', 'so'],
        weekHeader: 'TĂ˝den',
        dateFormat: 'd.m.yy',
        firstDay: 1,
        isRTL: false,
...
(function ($) {
    $.notifier = {
        $box: null,
        shownMilliseconds: 6000,
        boxId: 'notifier',
        boxClass: 'system-message-wrap',
        appendCloseAfterClass: '.system-message-content',
        closeClass: '.system-message-buttons',
        create: function () {
            var $closeSystemButton =
                '<div class="system-message-buttons">' +
                '<a title=" " href="#" class="system-message-close system-message-close-trigger">' +
                '</a></div>';
            var boxSelector =
                '<div id="' +
                this.boxId +
                '">' +
                '<div class="system-message-outer"><div class="system-message-inner">' +
                '<div class="system-message-content"></div></div></div></div>';
            var $box = $(boxSelector);
            $box.hide();
            $('#main').append($box);
            this.$box = $box;
            this.$closeSystemButton = $closeSystemButton;
        },
        showMessage: function (message, messageType) {
            ...
            switch (messageType) {
                case 'success':
                    messageClass = 'system-message-success';
                    break;
                case 'alert':
                    messageClass = 'system-message-alert';
                    break;
                case 'error':
                    messageClass = 'system-message-error';
                    break;
            }
            if (!$('#' + this.boxId).length) {
                this.create();
            }
            if (this.$box.is(':animated')) return false;
            this.$box
                .find(this.appendCloseAfterClass)
                .html(message)
                .end()
                .removeClass()
                .addClass(this.boxClass)
                .addClass(messageClass);
            if (this.$box.find(this.closeClass).length == 0) {
                this.$box.find(this.appendCloseAfterClass).after(this.$closeSystemButton);
            }
            this.$box.fadeIn(300).delay(this.shownMilliseconds).fadeOut(300);
        },
    };
})(jQuery);
(function ($, document, window) {
    ...
    function setSize(size, dimension) {
        return Math.round(
            (/%/.test(size) ? (dimension === 'x' ? winWidth() : winHeight()) / 100 : 1) * parseInt(size, 10),
        );
    }
    ...
    function appendHTML() {
        if (!$box && document.body) {
            ...
            $window = $(window);
            $box = $tag(div)
                .attr({ id: colorbox, class: isIE ? prefix + (isIE6 ? 'IE6' : 'IE') : '' })
                .hide();
            $overlay = $tag(div, 'Overlay', isIE6 ? 'position:absolute' : '').hide();
            $loadingOverlay = $tag(div, 'LoadingOverlay').add(
                $tag(div, 'LoadingGraphic').append(
                    '<svg height="80" width="80" ng-show="showpreloader" class="registration-circular">' +
                        '<circle cx="40" cy="40" r="32" fill="none" stroke-width="2" stroke-miterlimit="16" class="registration-path"></circle>' +
                        '</svg>',
                ),
            );
    ...
    publicMethod.position = function (speed, loadedCallback) {
        ...
        if (settings.bottom !== false) {
            top += Math.max(
                winHeight() - settings.h - loadedHeight - interfaceHeight - setSize(settings.bottom, 'y'),
                0,
            );
        ...
        speed =
            $box.width() === settings.w + loadedWidth && $box.height() === settings.h + loadedHeight ? 0 : speed || 0;
...
(function ($) {
    ...
    $.tools.tooltip = {
        conf: {
            ...
            layout: '<div><div class="tooltip-header"></div><div class="tooltip-content-wrapper"><div class="tooltip-content"></div></div><div class="tooltip-footer"></div></div>',
            tipClass: 'tooltip',
        },
    ...
    function Tooltip(trigger, conf) {
        var self = this,
            ...
            tipAlign = typeof trigger.attr('data-align') !== 'undefined' ? trigger.attr('data-align') : conf.align,
            tipWide = typeof trigger.attr('data-wide') !== 'undefined' ? 'wide' : conf.wide,
        ...
        $.extend(self, {
            show: function (e) {
                if (!tip) {
                    ...
                    if (!tip.length) {
                        ...
                        tip.addClass(tipAlign);
                        tip.addClass(tipWide);
                    }
                }
                if (self.isShown()) {
                    return self;
            ...
            update: function () {
                $(this.getTip()).find('.tooltip-content').html(this.getTrigger().attr('title'));
            },
        });
